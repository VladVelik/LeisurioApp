...
enum Texts {
    ...
    enum RecommendationsController {
        ...
        static let overlappingRests = NSLocalizedString("Ваши отдыхи пересекаются", comment: "")
        ...
        static let overlappingRestsDescription = NSLocalizedString("Некоторые из ваших отдыхов пересекаются по времени. Попробуйте уделить внимание планированию своего времени.", comment: "")
        static let longRestDescription = NSLocalizedString("Один из ваших отдыхов длиннее 12 часов. Постарайтесь разбивать длинные активности на более мелкие.", comment: "")
